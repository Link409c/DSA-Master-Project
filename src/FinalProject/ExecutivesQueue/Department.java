...
public class Department {
     ...
     * seniority in the department, with each executive receiving a raise of $5000 for each other
     * executive who is junior to them in the Department. The base salary for an executive is $40k.
     * If the department is Unemployed Executives, their pay is set to $0.
     */
    public void calculateSalaries(){
        if(!this.departmentName.equals("Unemployed")) {
            ...
            for(Executive e : getDeptExecutives()){
                e.setSalary(0);
            }
        }
    }
